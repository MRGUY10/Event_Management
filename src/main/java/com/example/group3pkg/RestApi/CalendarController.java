...
public class CalendarController {
    ...
    Iterable<Event> events(@RequestParam("start") @DateTimeFormat(iso = ISO.DATE_TIME) LocalDate start, @RequestParam("end") @DateTimeFormat(iso = ISO.DATE_TIME) LocalDate end) {
        System.out.println(er.findBetween(start, end).size());
